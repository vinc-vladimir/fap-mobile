    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/registrationplate', builder: (_, __) => const VehiclesListScreen()),
          GoRoute(path: '/registrationplate/add', builder: (_, __) => const VehicleFormScreen()),
          GoRoute(path: '/registrationplate/:id/edit', builder: (_, __) => const VehicleFormScreen()),
